...
export default function ArticleLock(props) {
  ...
  return (
    <div id='container' className='flex justify-center items-center h-96'>
      <div className='text-center space-y-3'>
        ...
        <div className='flex mx-4'>
          <input 
            ...
            className='outline-none w-full text-sm pl-5 rounded transition focus:shadow-lg font-light leading-10 text-black bg-gray-100 dark:bg-gray-500'
          />
          <button 
